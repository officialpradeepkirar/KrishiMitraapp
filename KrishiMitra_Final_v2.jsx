...
async function ai(prompt, img64=null, sys=null) {
  ...
  const r = await fetch("https://api.anthropic.com/v1/messages",{
    ...
    body:JSON.stringify({ model:"claude-sonnet-4-20250514", max_tokens:1000,
      system: sys||`Tu KrishiMitra AI hai — India ka sabse smart krishi sahayak (30 saal ka anubhav).
...
Numbers clearly do. MP/Madhya Pradesh context dhyan rakho. Emojis se structure karo.`,
  ...
  return d.content?.[0]?.text || "Jawab nahi mila.";
}
